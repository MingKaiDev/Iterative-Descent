...
public class PlayerMetricsTracker : MonoBehaviour
{
    ...
    // Tracks when the current quiz started so we can measure time taken
    ...
    /// <summary>
    /// Automatically called via PuzzleUI.OnPuzzleFinished event.
    /// No manual wiring needed — subscription is handled in OnEnable.
    /// </summary>
    private void HandleQuizFinished(int correct, int total)
    {
        ...
        // Rolling average: weight by attempt count
