...
| Runtime Inference | Sentis (.onnx) — pending Sprint 2 |
...
| Sprint 2 | PENDING | DirectorAgent.cs (PPO), reward function, EnemyDirector.cs, DifficultyProfile ScriptableObjects, Sentis inference |
